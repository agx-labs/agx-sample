<template>
  <a-form ref="formRef" :model="form" :rules="rules" layout="vertical">
    <a-row :gutter="20">
      ...
      <a-col :xs='24' :sm='24' :md='12'>
        <a-form-item label="排序:" name="fldSort">
          <a-input-number v-model:value="form.fldSort" style="width: 100%;"></a-input-number>
        </a-form-item>
      </a-col>
      <a-col :span="24">
...
const rules = reactive({
  ...
  fldSort: [{ required: true, message: '请输入排序', type: 'number', trigger: 'blur' }],
});
</script>
